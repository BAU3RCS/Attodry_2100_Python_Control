 ...
 */
int32_t __stdcall AttoDRY_Interface_get40KStageTemperature(
 ...
 * <B>Path</B>
 */
int32_t __stdcall AttoDRY_Interface_downloadTemperatureSensorCalibrationCurve(
 ...
 */
int32_t __stdcall AttoDRY_Interface_end(void);
/*!
 * Returns the temperature of the 4 Kelvin Stage
 */
int32_t __stdcall AttoDRY_Interface_get4KStageTemperature(
 ...
 */
int32_t __stdcall AttoDRY_Interface_getActionMessage(char ActionMessage[], 
	int32_t len);
/*!
 * Returns the current error message
 */
int32_t __stdcall AttoDRY_Interface_getAttodryErrorMessage(char ErrorMessage[], 
	int32_t len);
/*!
 * Returns the current error code
 */
int32_t __stdcall AttoDRY_Interface_getAttodryErrorStatus(uint8_t *ErrorCode);
/*!
 ...
 */
int32_t __stdcall AttoDRY_Interface_getDerivativeGain(float *DerivativeGain);
/*!
 ...
 * the <B>Exchange Heater</B> gain is returned
 */
int32_t __stdcall AttoDRY_Interface_getIntegralGain(float *IntegralGain);
/*!
 * Gets the current magnetic field
 */
int32_t __stdcall AttoDRY_Interface_getMagneticField(float *MagneticFieldYT);
/*!
 * Gets the current magnetic field set point
 */
int32_t __stdcall AttoDRY_Interface_getMagneticFieldSetPoint(
 ...
 * the <B>Exchange Heater</B> gain is returned
 */
int32_t __stdcall AttoDRY_Interface_getProportionalGain(
 ...
 */
int32_t __stdcall AttoDRY_Interface_getSampleHeaterMaximumPower(
	float *MaximumPower);
/*!
 * Gets the current Sample Heater power, in Watts
 */
int32_t __stdcall AttoDRY_Interface_getSampleHeaterPower(
 ...
 * HeaterResistance
 */
int32_t __stdcall AttoDRY_Interface_getSampleHeaterResistance(
 ...
 * HeaterResistance
 */
int32_t __stdcall AttoDRY_Interface_getSampleHeaterWireResistance(
 ...
 */
int32_t __stdcall AttoDRY_Interface_getSampleTemperature(float *Temperature);
/*!
 ...
 */
int32_t __stdcall AttoDRY_Interface_getUserTemperature(float *Temperature);
/*!
 * Returns the VTI Heater power, in Watts
 */
int32_t __stdcall AttoDRY_Interface_getVtiHeaterPower(float *VTIHeaterPowerW);
/*!
 * Returns the temperature of the VTI
 */
int32_t __stdcall AttoDRY_Interface_getVtiTemperature(float *VTITemperatureK);
/*!
 * Initiates the "Base Temperature" command, as on the touch screen
 */
int32_t __stdcall AttoDRY_Interface_goToBaseTemperature(void);
/*!
 ...
 * the icon is white.
 */
int32_t __stdcall AttoDRY_Interface_isControllingField(
 ...
 * icon is white.
 */
int32_t __stdcall AttoDRY_Interface_isControllingTemperature(
 ...
 * attoDRY
 */
int32_t __stdcall AttoDRY_Interface_isDeviceInitialised(int *Initialised);
/*!
 * Checks to see if the attoDRY is connected. Returns True if connected.
 */
int32_t __stdcall AttoDRY_Interface_isDeviceConnected(int *isConnected);
/*!
 ...
 * the button is white.
 */
int32_t __stdcall AttoDRY_Interface_isGoingToBaseTemperature(
 ...
 * the field.
 */
int32_t __stdcall AttoDRY_Interface_isPersistentModeSet(
	int *PersistentMode);
/*!
 * Returns true if the pump is running
 */
int32_t __stdcall AttoDRY_Interface_isPumping(int *Pumping);
/*!
 ...
 * the button is white.
 */
int32_t __stdcall AttoDRY_Interface_isSampleExchangeInProgress(
 ...
 */
int32_t __stdcall AttoDRY_Interface_isSampleHeaterOn(
	int *SampleHeaterStatus);
/*!
 * This will return true when the sample stick is ready to be removed or 
 * inserted.
 */
int32_t __stdcall AttoDRY_Interface_isSampleReadyToExchange(
	int *ReadyToExchange);
/*!
 * Checks to see if the system is running, that is, if the compressor is 
 * running etc
 */
int32_t __stdcall AttoDRY_Interface_isSystemRunning(int *SystemRunning);
/*!
 ...
 * button is white.
 */
int32_t __stdcall AttoDRY_Interface_isZeroingField(int *ZeroingField);
/*!
 * Lowers any raised errors
 */
int32_t __stdcall AttoDRY_Interface_lowerError(void);
/*!
 ...
 * the attoDRY is turned off.
 */
int32_t __stdcall AttoDRY_Interface_querySampleHeaterMaximumPower(void);
/*!
 ...
 * HeaterResistance
 */
int32_t __stdcall AttoDRY_Interface_querySampleHeaterResistance(void);
/*!
 ...
 * HeaterResistance
 */
int32_t __stdcall AttoDRY_Interface_querySampleHeaterWireResistance(void);
/*!
 ...
 */
int32_t __stdcall AttoDRY_Interface_setDerivativeGain(float DerivativeGain);
/*!
 ...
 * the <B>Exchange Heater</B> gain is set
 */
int32_t __stdcall AttoDRY_Interface_setIntegralGain(float IntegralGain);
/*!
 ...
 * the <B>Exchange Heater</B> gain is set
 */
int32_t __stdcall AttoDRY_Interface_setProportionalGain(float ProportionalGain);
/*!
 ...
 */
int32_t __stdcall AttoDRY_Interface_setSampleHeaterMaximumPower(
	float MaximumPower);
/*!
 ...
 * careful about how often you set this value.
 */
int32_t __stdcall AttoDRY_Interface_setSampleHeaterWireResistance(
	float WireResistance);
/*!
 * Sets the sample heater value to the specified value
 */
int32_t __stdcall AttoDRY_Interface_setSampleHeaterPower(float HeaterPowerW);
/*!
 ...
 * careful about how often you set this value.
 */
int32_t __stdcall AttoDRY_Interface_setSampleHeaterResistance(
	float HeaterResistance);
/*!
 * Sets the user magntic field. This is used as the set point when field 
 * control is active
 */
int32_t __stdcall AttoDRY_Interface_setUserMagneticField(
	float MagneticFieldSetPointT);
/*!
 * Sets the user temperature. This is the temperature used when temperature 
 * control is enabled.
 */
int32_t __stdcall AttoDRY_Interface_setUserTemperature(float Temperature);
/*!
 * Starts logging data to the file specifed by <B>Path</B>. 
 * 
 * If the file does not exist, it will be created.
 */
int32_t __stdcall AttoDRY_Interface_startLogging(char Path[], 
	Enum TimeSelection, int Append);
/*!
 * Starts the sample exchange procedure
 */
int32_t __stdcall AttoDRY_Interface_startSampleExchange(void);
/*!
 * Stops logging data
 */
int32_t __stdcall AttoDRY_Interface_stopLogging(void);
/*!
 * Initiates the "Zero Field" command, as on the touch screen
 */
int32_t __stdcall AttoDRY_Interface_sweepFieldToZero(void);
/*!
 * Toggles temperature control, just as the thermometer icon on the touch 
 * screen.
 */
int32_t __stdcall AttoDRY_Interface_toggleFullTemperatureControl(void);
/*!
 * Toggle magnetic field control, just as the magnet icon on the touch screen
 */
int32_t __stdcall AttoDRY_Interface_toggleMagneticFieldControl(void);
/*!
 ...
 */
int32_t __stdcall AttoDRY_Interface_togglePersistentMode(void);
/*!
 * Starts and stops the pump. If the pump is running, it will stop it. If the 
 * pump is not running, it will be started.
 */
int32_t __stdcall AttoDRY_Interface_togglePump(void);
/*!
 ...
 */
int32_t __stdcall AttoDRY_Interface_toggleSampleTemperatureControl(void);
/*!
 * Toggles the start up/shutdown procedure. If the attoDRY is started up, the 
 * shut down procedure will be run and vice versa
 */
int32_t __stdcall AttoDRY_Interface_toggleStartUpShutdown(void);
/*!
 * Starts the upload of a <B>.crv calibration curve file</B> to the <B>sample 
 * temperature sensor</B>
 */
int32_t __stdcall AttoDRY_Interface_uploadSampleTemperatureCalibrationCurve(
	char Path[]);
/*!
 ...
 * 1 to 8, inclusive
 */
int32_t __stdcall AttoDRY_Interface_uploadTemperatureCalibrationCurve(
	uint8_t UserCurveNumber, char Path[]);
/*!
 * AttoDRY_Interface_setVTIHeaterPower
 */
int32_t __stdcall AttoDRY_Interface_setVTIHeaterPower(float VTIHeaterPowerW);
/*!
 * AttoDRY_Interface_queryReservoirTsetColdSample
 */
int32_t __stdcall AttoDRY_Interface_queryReservoirTsetColdSample(void);
/*!
 * AttoDRY_Interface_getReservoirTsetColdSample
 */
int32_t __stdcall AttoDRY_Interface_getReservoirTsetColdSample(
	float *ReservoirTsetColdSampleK);
/*!
 * AttoDRY_Interface_setReservoirTsetWarmMagnet
 */
int32_t __stdcall AttoDRY_Interface_setReservoirTsetWarmMagnet(
	float ReservoirTsetWarmMagnetW);
/*!
 * AttoDRY_Interface_setReservoirTsetColdSample
 */
int32_t __stdcall AttoDRY_Interface_setReservoirTsetColdSample(
	float SetReservoirTsetColdSampleK);
/*!
 * AttoDRY_Interface_setReservoirTsetWarmSample
 */
int32_t __stdcall AttoDRY_Interface_setReservoirTsetWarmSample(
	float ReservoirTsetWarmSampleW);
/*!
 * AttoDRY_Interface_queryReservoirTsetWarmSample
 */
int32_t __stdcall AttoDRY_Interface_queryReservoirTsetWarmSample(void);
/*!
 * AttoDRY_Interface_queryReservoirTsetWarmMagnet
 */
int32_t __stdcall AttoDRY_Interface_queryReservoirTsetWarmMagnet(void);
/*!
 * AttoDRY_Interface_getReservoirTsetWarmSample
 */
int32_t __stdcall AttoDRY_Interface_getReservoirTsetWarmSample(
	float *ReservoirTsetWarmSampleK);
/*!
 * AttoDRY_Interface_getReservoirTsetWarmMagnet
 */
int32_t __stdcall AttoDRY_Interface_getReservoirTsetWarmMagnet(
	float *ReservoirTsetWarmMagnetK);
/*!
 * Gets the current magnetic field
 */
int32_t __stdcall AttoDRY_Interface_getMagneticFieldX(float *MagneticFieldXT);
/*!
 * Gets the current magnetic field
 */
int32_t __stdcall AttoDRY_Interface_getMagneticFieldZ(float *MagneticFieldZT);
/*!
 * Gets the current magnetic field set point
 */
int32_t __stdcall AttoDRY_Interface_getMagneticFieldSetPointX(
	float *MagneticFieldSetPointXT);
/*!
 * Gets the current magnetic field set point
 */
int32_t __stdcall AttoDRY_Interface_getMagneticFieldSetPointZ(
	float *MagneticFieldSetPointZT);
/*!
 * AttoDRY_Interface_setUserMagneticFieldX
 */
int32_t __stdcall AttoDRY_Interface_setUserMagneticFieldX(
	float MagneticFieldSetPointT);
/*!
 * AttoDRY_Interface_setUserMagneticFieldZ
 */
int32_t __stdcall AttoDRY_Interface_setUserMagneticFieldZ(
	float MagneticFieldSetPointT);
/*!
 * ATTODRY2100 ONLY. Gets the current status of the Dump In volume valve. 
 */
int32_t __stdcall AttoDRY_Interface_getHeValve(int *valveStatus);
/*!
 * Gets the Cryostat Outlet pressure
 */
int32_t __stdcall AttoDRY_Interface_getPressure2(
	float *CryostatOutPressureMbar);
/*!
 * ATTODRY2100 ONLY. Toggles the Cryostat In valve. If it is closed, it will 
 * open and if it is open, it will close. 
 */
int32_t __stdcall AttoDRY_Interface_toggleValveSampleSpace(void);
/*!
 * ATTODRY2100 ONLY. Gets the current status of the outer volume valve. 
 */
int32_t __stdcall AttoDRY_Interface_getPump800Valve(int *valveStatus);
/*!
 * ATTODRY2100 ONLY. Gets the current status of the Cryostat In valve.
 */
int32_t __stdcall AttoDRY_Interface_getSampleSpaceValve(int *valveStatus);
/*!
 * ATTODRY2100 ONLY. Gets the current status of the Cryostat Out valve.
 */
int32_t __stdcall AttoDRY_Interface_getValve2(int *valveStatus);
/*!
 * Gets the current temperature of the Helium Reservoir, in Kelvin
 */
int32_t __stdcall AttoDRY_Interface_getTemperature4(
	float *ReservoirTemperatureK);
/*!
 * ATTODRY2100 ONLY. Toggles the outer volume valve. If it is closed, it will 
 * open and if it is open, it will close. 
 */
int32_t __stdcall AttoDRY_Interface_togglePump800Valve(void);
/*!
 * ATTODRY2100 ONLY. Toggles the Cryostat Out valve. If it is closed, it will 
 * open and if it is open, it will close. 
 */
int32_t __stdcall AttoDRY_Interface_toggleValveBreakVac(void);
/*!
 * ATTODRY2100 ONLY. Gets the pressure at the Cryostat Inlet
 */
int32_t __stdcall AttoDRY_Interface_getPressure1(float *CryostatInPressureMbar);
/*!
 * ATTODRY2100 ONLY. Toggles the inner volume valve. If it is closed, it will 
 * open and if it is open, it will close. 
 */
int32_t __stdcall AttoDRY_Interface_toggleHelium800Valve(void);
/*!
 * AttoDRY_Interface_GetTurbopumpFrequ800
 */
int32_t __stdcall AttoDRY_Interface_GetTurbopumpFrequ800(
	uint16_t *TurbopumpFrequencyHz);

MgErr __stdcall LVDLLStatus(char *errStr, int errStrLen, void *module);
