 ...
 */
int32_t __cdecl AttoDRY_Interface_get40KStageTemperature(float *_40KStageTemperatureK);
 ...
 */
int32_t __cdecl AttoDRY_Interface_isExchangeHeaterOn(int *ExchangeHeaterStatus);

/*!
 * ATTODRY1100 ONLY. Gets the current frequency of the turbopump.
 */
int32_t __cdecl AttoDRY_Interface_getTurbopumpFrequency(uint16_t *TurbopumpFrequencyHz);
 ...
 */
int32_t __cdecl AttoDRY_Interface_getCryostatInPressure(float *CryostatInPressureMbar);
 ...
 */
int32_t __cdecl AttoDRY_Interface_getCryostatOutPressure(float *CryostatOutPressureMbar);
 ...
 */
int32_t __cdecl AttoDRY_Interface_getReservoirHeaterPower(float *ReservoirHeaterPowerW);

/*!
 * Gets the current temperature of the Helium Reservoir, in Kelvin
 */
int32_t __cdecl AttoDRY_Interface_getReservoirTemperature(float *ReservoirTemperatureK);
 ...
 */
int32_t __cdecl AttoDRY_Interface_downloadSampleTemperatureSensorCalibrationCurve(char SavePath[]);
 ...
 * <B>Path</B>
 */
int32_t __cdecl AttoDRY_Interface_downloadTemperatureSensorCalibrationCurve(uint8_t UserCurveNumber, char Path[]);
 ...
 */
int32_t __cdecl AttoDRY_Interface_get4KStageTemperature(float *_4KStageTemperatureK);
 ...
 */
int32_t __cdecl AttoDRY_Interface_getActionMessage(char ActionMessage[], int32_t len);

/*!
 * Returns the current error message
 */
int32_t __cdecl AttoDRY_Interface_getAttodryErrorMessage(char ErrorMessage[], int32_t len);
 ...
 */
int32_t __cdecl AttoDRY_Interface_getMagneticField(float *MagneticFieldYT);

/*!
 * Gets the current magnetic field set point
 */
int32_t __cdecl AttoDRY_Interface_getMagneticFieldSetPoint(float *MagneticFieldSetPointT);
 ...
 * the <B>Exchange Heater</B> gain is returned
 */
int32_t __cdecl AttoDRY_Interface_getProportionalGain(float *ProportionalGain);
 ...
 */
int32_t __cdecl AttoDRY_Interface_getSampleHeaterMaximumPower(float *MaximumPower);

/*!
 * Gets the current Sample Heater power, in Watts
 */
int32_t __cdecl AttoDRY_Interface_getSampleHeaterPower(float *SampleHeaterPowerW);
 ...
 * HeaterResistance
 */
int32_t __cdecl AttoDRY_Interface_getSampleHeaterResistance(float *HeaterResistance);
 ...
 * HeaterResistance
 */
int32_t __cdecl AttoDRY_Interface_getSampleHeaterWireResistance(float *WireResistance);
 ...
 * the icon is white.
 */
int32_t __cdecl AttoDRY_Interface_isControllingField(int *ControllingField);
 ...
 * icon is white.
 */
int32_t __cdecl AttoDRY_Interface_isControllingTemperature(int *ControllingTemperature);
 ...
 * the button is white.
 */
int32_t __cdecl AttoDRY_Interface_isGoingToBaseTemperature(int *GoingToBaseTemperature);
 ...
 * the field.
 */
int32_t __cdecl AttoDRY_Interface_isPersistentModeSet(int *PersistentMode);
 ...
 * the button is white.
 */
int32_t __cdecl AttoDRY_Interface_isSampleExchangeInProgress(int *ExchangingSample);

/*!
 * Checks to see if the sample heater is on. 'On' is defined as PID control is 
 * active or a contant heater power is set. 
 */
int32_t __cdecl AttoDRY_Interface_isSampleHeaterOn(int *SampleHeaterStatus);

/*!
 * This will return true when the sample stick is ready to be removed or 
 * inserted.
 */
int32_t __cdecl AttoDRY_Interface_isSampleReadyToExchange(int *ReadyToExchange);
 ...
 */
int32_t __cdecl AttoDRY_Interface_setSampleHeaterMaximumPower(float MaximumPower);
 ...
 * careful about how often you set this value.
 */
int32_t __cdecl AttoDRY_Interface_setSampleHeaterWireResistance(float WireResistance);
 ...
 * careful about how often you set this value.
 */
int32_t __cdecl AttoDRY_Interface_setSampleHeaterResistance(float HeaterResistance);

/*!
 * Sets the user magntic field. This is used as the set point when field 
 * control is active
 */
int32_t __cdecl AttoDRY_Interface_setUserMagneticField(float MagneticFieldSetPointT);
 ...
 */
int32_t __cdecl AttoDRY_Interface_startLogging(char Path[], Enum TimeSelection, int Append);
 ...
 */
int32_t __cdecl AttoDRY_Interface_uploadSampleTemperatureCalibrationCurve(char Path[]);
 ...
 * 1 to 8, inclusive
 */
int32_t __cdecl AttoDRY_Interface_uploadTemperatureCalibrationCurve(uint8_t UserCurveNumber, char Path[]);
 ...
 */
int32_t __cdecl AttoDRY_Interface_getReservoirTsetColdSample(float *ReservoirTsetColdSampleK);

/*!
 * AttoDRY_Interface_setReservoirTsetWarmMagnet
 */
int32_t __cdecl AttoDRY_Interface_setReservoirTsetWarmMagnet(float ReservoirTsetWarmMagnetW);

/*!
 * AttoDRY_Interface_setReservoirTsetColdSample
 */
int32_t __cdecl AttoDRY_Interface_setReservoirTsetColdSample(float SetReservoirTsetColdSampleK);

/*!
 * AttoDRY_Interface_setReservoirTsetWarmSample
 */
int32_t __cdecl AttoDRY_Interface_setReservoirTsetWarmSample(float ReservoirTsetWarmSampleW);
 ...
 */
int32_t __cdecl AttoDRY_Interface_getReservoirTsetWarmSample(float *ReservoirTsetWarmSampleK);

/*!
 * AttoDRY_Interface_getReservoirTsetWarmMagnet
 */
int32_t __cdecl AttoDRY_Interface_getReservoirTsetWarmMagnet(float *ReservoirTsetWarmMagnetK);

/*!
 * Gets the current magnetic field
 */
int32_t __cdecl AttoDRY_Interface_getMagneticFieldX(float *MagneticFieldXT);

/*!
 * Gets the current magnetic field
 */
int32_t __cdecl AttoDRY_Interface_getMagneticFieldZ(float *MagneticFieldZT);

/*!
 * Gets the current magnetic field set point
 */
int32_t __cdecl AttoDRY_Interface_getMagneticFieldSetPointX(float *MagneticFieldSetPointXT);

/*!
 * Gets the current magnetic field set point
 */
int32_t __cdecl AttoDRY_Interface_getMagneticFieldSetPointZ(float *MagneticFieldSetPointZT);

/*!
 * AttoDRY_Interface_setUserMagneticFieldX
 */
int32_t __cdecl AttoDRY_Interface_setUserMagneticFieldX(float MagneticFieldSetPointT);

/*!
 * AttoDRY_Interface_setUserMagneticFieldZ
 */
int32_t __cdecl AttoDRY_Interface_setUserMagneticFieldZ(float MagneticFieldSetPointT);

/*!
 * ATTODRY2100 ONLY. Gets the current status of the Dump In volume valve. 
 */
int32_t __cdecl AttoDRY_Interface_getHeValve(int *valveStatus);

/*!
 * Gets the Cryostat Outlet pressure
 */
int32_t __cdecl AttoDRY_Interface_getPressure2(float *CryostatOutPressureMbar);

/*!
 * ATTODRY2100 ONLY. Toggles the Cryostat In valve. If it is closed, it will 
 * open and if it is open, it will close. 
 */
int32_t __cdecl AttoDRY_Interface_toggleValveSampleSpace(void);
 ...
 * ATTODRY2100 ONLY. Gets the current status of the Cryostat In valve.
 */
int32_t __cdecl AttoDRY_Interface_getSampleSpaceValve(int *valveStatus);

/*!
 * ATTODRY2100 ONLY. Gets the current status of the Cryostat Out valve.
 */
int32_t __cdecl AttoDRY_Interface_getValve2(int *valveStatus);

/*!
 * Gets the current temperature of the Helium Reservoir, in Kelvin
 */
int32_t __cdecl AttoDRY_Interface_getTemperature4(float *ReservoirTemperatureK);
 ...
 * open and if it is open, it will close. 
 */
int32_t __cdecl AttoDRY_Interface_toggleValveBreakVac(void);

/*!
 * ATTODRY2100 ONLY. Gets the pressure at the Cryostat Inlet
 */
int32_t __cdecl AttoDRY_Interface_getPressure1(float *CryostatInPressureMbar);

/*!
 * ATTODRY2100 ONLY. Toggles the inner volume valve. If it is closed, it will 
 * open and if it is open, it will close. 
 */
int32_t __cdecl AttoDRY_Interface_toggleHelium800Valve(void);

/*!
 * AttoDRY_Interface_GetTurbopumpFrequ800
 */
int32_t __cdecl AttoDRY_Interface_GetTurbopumpFrequ800(uint16_t *TurbopumpFrequencyHz);
