...
# Example of how to use the attoDRYDLL in Python 3.9. This example is done using an attoDRY2100std with a 64bit python.
...
loc = r"..\01 DLLs for different Cryostat Versions\for vector magnet\64 bit\attoDRYxyz64bit.dll"
...
#adjust COM port
err2 = lib.AttoDRY_Interface_Connect(ct.c_char_p(b"COM3"))  
print("err2", err2)
...
while running.value == 0:
    ...
    time.sleep(1)
#The block below reads the user temperature i.e. the setpoint, not the current value.
